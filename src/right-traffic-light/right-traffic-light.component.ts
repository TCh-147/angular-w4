...
@Component({
    selector: 'right-traffic-light-root',
    standalone: true,
...
export class RightLight implements OnChanges{
  ...
  public turnYellow(){
    ...
    this.resetColors();
    this.yellow = document.getElementById("right-yellow");
  ...
  public turnGreen(){
    ...
    this.resetColors();
    this.green = document.getElementById("right-green");
  ...
  public turnRed(){
    ...
    this.red = document.getElementById("right-red");
  ...
  private showDisBtn(){
    ...
    this.btn = document.getElementById("right-btn");
    this.btn.setAttribute("style", "display: none;");
    this.btnDis = document.getElementById("right-btn-dis");
